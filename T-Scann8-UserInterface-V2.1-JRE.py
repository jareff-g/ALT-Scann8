...
DisablePreview_btn = Button(win, text="Disable Preview", width=8, height=3, command=disable_preview, activebackground='green', activeforeground='white', wraplength=80)
